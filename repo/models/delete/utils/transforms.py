...
from repo.datasets.del_data import ProteinLigandData
...
from repo.datasets.del_data import ProteinLigandData
from repo.models.delete.utils.misc import *
from repo.models.delete.utils.protein_ligand import ATOM_FAMILIES
...
class LigandMaskFrag(object):
    ...
    def __call__(self, data):
        try:
            ...
            masked_idx = data.masked_idx[0]
            context_idx = data.context_idx[0]
...
def get_mask(cfg):
    ...
    elif cfg.type == 'linker_single':
        return LigandMaskFrag(masker='linker')
    elif cfg.type == 'frag_single':
        return LigandMaskFrag(masker='frag')
    elif cfg.type == 'scaffold_single':
        return LigandMaskFrag(masker='scaffold')
    elif cfg.type == 'sidechain_single':
        return LigandMaskFrag(masker='side_chain')
    else:
