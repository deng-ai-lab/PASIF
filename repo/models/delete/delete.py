...
from repo.models.delete.interaction import get_encoder_vn
from repo.models.delete.model_utils import *
from repo.models.delete.embedding import AtomEmbedding
from repo.models.delete.generation import get_field_vn  # topology generation
from repo.models.delete.generation import FrontierLayerVN  # attachment
from repo.models.delete.generation import PositionPredictor # geometry generation
from repo.models.delete.utils.misc import unique
...
class Delete(Module):
    ...
    def sample_position(self,
        ...
        # delete tyll
            ...
            pos_generated = self.pos_predictor.sample_batch(abs_pos_mu, pos_sigma, pos_pi, n_samples)
            n_candidate_samples = pos_generated.size(1)
            pos_generated = torch.reshape(pos_generated, [-1, 3])
            pdf_pos = self.pos_predictor.get_mdn_probability(
                mu=torch.repeat_interleave(abs_pos_mu, repeats=n_candidate_samples, dim=0),
