...
import repo.models.charge_density.layer as layer
from repo.models.charge_density.layer import ShiftedSoftplus
...
def load_model(model_dir, device):
    ...
    if runner_args.use_painn_model:
        model = PainnDensityModel(runner_args.num_interactions, runner_args.node_size, runner_args.cutoff)
    else:
        model = DensityModel(runner_args.num_interactions, runner_args.node_size, runner_args.cutoff)
