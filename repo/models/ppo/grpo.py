...
class ConstantGRPOTrainer(nn.Module):
    def __init__(self, actor: ConstantActor, reward: ConstantReward, 
                 sampler, discrete_type='gauss'):
        super(ConstantGRPOTrainer, self).__init__()
    ...
    def ppo_update(self, batch, old_actor):
        ...
        advantages = reward_v - reward_v.mean(dim=0, keepdim=True)
