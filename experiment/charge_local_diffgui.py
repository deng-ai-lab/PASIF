...
if __name__ == '__main__':
    ...
    parser.add_argument('--density_path', type=str, default="./data/charge_test/BSD_ASPTE_1_130_0/dft.npy")
    parser.add_argument('--frag', type=str, default="./data/charge_test/BSD_ASPTE_1_130_0/2z3h_A_rec_1wn6_bst_lig_tt_docked_3.sdf")
    parser.add_argument('--target', type=str, default="./data/charge_test/BSD_ASPTE_1_130_0/2z3h_A_rec_1wn6_bst_lig_tt_docked_3_pocket10.pdb")
    parser.add_argument('--mask', type=str, default="./data/charge_test/BSD_ASPTE_1_130_0/mask.npy")
    ...
    parser.add_argument('--out_root', type=str, default='./results/charge_local')
