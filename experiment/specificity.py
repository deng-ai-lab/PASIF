...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='./logs/denovo/targetdiff/pretrain/checkpoints/pretrained.pt')
    ...
    parser.add_argument('--model_name', type=str, default='targetdiff')
